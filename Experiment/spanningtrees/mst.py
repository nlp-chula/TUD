...
from .edge_priority_queue import EdgePriorityQueue
from .brute_force import all_unrooted_spanning_trees, all_rooted_spanning_trees
...
class MST:
    ...
    def mst(
        self,
        root_constraint: bool = False,
        include_set: list[Edge] | None = None,
        exclude_set: list[Edge] | None = None,
        reweight: bool = False
    ):
